...
<section>
        ...
        <form action="" method="" class="style_form">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="FirstName" id="FirstName"required oninvalid="setCustomValidity('Esta campo es obligatorio')" placeholder=" write your name please" pattern="[A-Z a-z]{4,50}" >
            </div>
            <br>
            <div class="mb-3">
